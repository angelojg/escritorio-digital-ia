...
async def wpp(b: WppInput):
    ...
    esc=resp.upper().startswith("ESCALAR:") or any(g in b.mensagem.lower().encode("ascii","ignore").decode() for g in ["cancelar","desistir","intimac","citac","audienc","recurso","oab","advogado"])
    mot=None
