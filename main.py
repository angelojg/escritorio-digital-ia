...
async def classificar(b: LeadInput):
    ...
    try:
        r=json.loads(__import__("re").sub(r"`{3}(?:json)?\s*", "", raw).strip())
        log.info(f"Triagem: {r.get(chr(116)+chr(101)+chr(115)+chr(101))} v={r.get(chr(118)+chr(105)+chr(97)+chr(98)+chr(105)+chr(108)+chr(105)+chr(100)+chr(97)+chr(100)+chr(101))}% rec={r.get(chr(114)+chr(101)+chr(99)+chr(111)+chr(109)+chr(101)+chr(110)+chr(100)+chr(97)+chr(99)+chr(97)+chr(111))}")
        return r
